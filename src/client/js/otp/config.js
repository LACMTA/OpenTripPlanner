otp.config = {
    ...
    siteName            : "Metro OTP test",
    siteDescription     : "Beta OpenTripPlanner deployment.",
...
otp.config.modes = {
    ...
    //Options widgets)
        "TRANSIT,WALK"        : _tr("Transit (bus and rail)"),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
    //Options widgets)
        // "BUSISH,WALK"         : _tr("Bus Only"),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
    //Options widgets)
        "TRAINISH,WALK"       : _tr("Rail"),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
    //Options widgets)
        // "BICYCLE"             : _tr('Bicycle Only'),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
    //Options widgets)
        "TRANSIT,BICYCLE"     : _tr("Bicycle and Transit"),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
    //Options widgets)
        "WALK"                : _tr('Walk'),
    //TRANSLATORS: Travel by: mode of transport (Used in selection in Travel
